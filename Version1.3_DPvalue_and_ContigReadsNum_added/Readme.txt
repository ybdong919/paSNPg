...
 
Output files:
Readsnum_of_contig.txt includes the number of reads of each sample covering every contigs.
...
Nu_genotypes_DP.txt includes raw read depth (DP) in every SNP sites of each sample .
